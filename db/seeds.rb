...
guest_1 = cabin_1.guests.create(first_name: 'John', last_name:'Doe', invite: false, plus_ones: 0)
guest_1 = cabin_2.guests.create(first_name: 'Jane', last_name:'Doe', invite: true, plus_ones: 0)